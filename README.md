...
* I created that project just to do something so if there is any bugs i dont know about them because i am not able to acyally use it (I dont need to write anything on something that not english/russian and even if i would want to wrtite smth on hebrew with my very small knowlege of it i dont have hebrew letters on my keycaps).
